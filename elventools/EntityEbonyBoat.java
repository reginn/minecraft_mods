...
public class EntityEbonyBoat extends Entity
{
	...
	public EntityEbonyBoat(World par1World)
	{
		super(par1World);
	...
	public EntityEbonyBoat(World par1World, double par2, double par4, double par6)
	{
		this(par1World);
