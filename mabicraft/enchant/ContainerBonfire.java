...
public class ContainerBonfire extends Container
{
	...
	public ContainerBonfire(EntityPlayer player, World world, int x, int y, int z)
	{
		...
		addSlotToContainer(new SlotRestricted(inventoryBonfire, 1, 26, 17 + 18, MabiCraftItem.itemManaHerb.itemID));
		addSlotToContainer(new SlotRestricted(inventoryBonfire, 2, 26, 17 + 36, MabiCraftItem.itemBlessedPotion.itemID));
