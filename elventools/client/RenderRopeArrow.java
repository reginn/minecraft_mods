...
{
    public void renderArrow(EntityRopeArrow par1EntityArrow, double par2, double par4, double par6, float par8, float par9)
    {
    ...
    {
        this.renderArrow((EntityRopeArrow)par1Entity, par2, par4, par6, par8, par9);
    }
}
