package rgn.mods.mabicraft.client.model;
...
public class ModelMabiWolf extends ModelBase
{
	...
	public void setLivingAnimations(EntityLiving par1EntityLiving, float par2, float par3, float par4)
	{
		...
		/*
		this.wolfHeadMain.rotateAngleZ = par1EntityLiving.getInterestedAngle(par4) + par1EntityLiving.getShakeAngle(par4, 0.0F);
		this.wolfMane.rotateAngleZ = par1EntityLiving.getShakeAngle(par4, -0.08F);
		this.wolfBody.rotateAngleZ = par1EntityLiving.getShakeAngle(par4, -0.16F);
		this.wolfTail.rotateAngleZ = par1EntityLiving.getShakeAngle(par4, -0.2F);
		*/
	}
